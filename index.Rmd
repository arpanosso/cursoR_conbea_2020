...
```{r}
dados <- read.table("https://raw.githubusercontent.com/arpanosso/cursoR_conbea_2020/main/dados/geomorfologia.txt", h=TRUE,sep="\t")
```
...
dados %>% 
  ggplot(aes(x=Mg,y=Ca) ) + # dizer quem será o x e o y dentro de aes, ou seja, sua estética
  geom_point() # chamar a geometria do gráfico, ou seja, tipod e gráfico
```
